...
from federation.transfer_inst import TransferInst
...
class HeteroSecureBoostingTreeHost(BoostingTree):
    ...
    def sync_model_to_guest(self):
        ...
        #         tree_inst.set_runtime_idx(self.runtime_idx)
        #         maskdict = {}
        #         for k in tree_inst.split_maskdict:
        #             maskdict[k] = tree_inst.split_maskdict[k]
        #         split_maskdicts_host[k] = maskdict         
        self.transfer_inst.send_data_to_guest(split_maskdicts_host)
        self.transfer_inst.send_data_to_guest(self.feature_name_fid_mapping)
